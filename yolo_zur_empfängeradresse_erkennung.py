...
@transform(
    new_checkpoint=Output("ri.foundry.main.dataset.0bf02132-fd45-46a8-abbb-ce20b8a4df59"),
    train_data=Input("ri.foundry.main.dataset.b9a35e1d-8d9f-4619-b77c-f9a0eb8a12ea")
)
def compute(ctx, new_checkpoint, train_data):
    ...
    # by default, patience (early stopping) = 50 
    results = model.train(
        data=DATA_YAML,
        epochs=EPOCHS,
        batch=BATCH,
